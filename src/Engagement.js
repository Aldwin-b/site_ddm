    ...
    <div className="engagement_container">
      ...
      <div className="engagement_container_textB">
        <div className="text_W text_E">
          ...
          déplacements et transports du matériel. Cet acte contribue à stimuler
          le tissu local et favorise notre implantation en terre montendraise.
        </div>
      </div>
      <div className="engagement_title2_container">
      ...
      <div className="engagement_container_textB">
        <div className="text_W text_E">
          ...
          maximum le gaspillage, ainsi toute la vaisselle de notre espace
          bénévole est réutilisable et nos déchets alimentaires sont compostés !
        </div>
      </div>
      <div className="engagement_title2_container">
      ...
      <div className="engagement_container_textB">
        <div className="text_W text_E">
          ...
          l’événement. Nos engagements Décors Enfin, la décoration du engagement
          est réalisée à partir de matériaux de récupération. Une grande partie
          du matériel technique est mis à disposition par les collectivités et
          les partenaires afin de privilégier la mise en commun.
        </div>
      </div>
      <div className="engagement_title2_container">
      ...
      <div className="engagement_container_textB">
        <div className="text_W text_E">
          ...
          éditions suivantes, et nous n’en commandons que peu de nouveaux chaque
          année.
        </div>
      </div>
      <div className="engagement_title2_container">

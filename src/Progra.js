      ...
      <div>
        ...
        <div className="progra_cols">
          <div className="progra_col">
            <div className="title">
              <div className="progra_title_day "> VENDREDI 10 JUILLET</div>
            </div>
          ...
          <div className="progra_col">
            <div className="title">
              <div className="progra_title_day "> SAMEDI 11 JUILLET</div>
            </div>
            <div className="progra_col_main">
              <ProgramListS />
            </div>
          ...
          <div>
            <div className="progra_col">
              <div className="progra_title">
                <div className="progra_title_day "> VENDREDI 10</div>
              </div>
              <div className="progra_col_main">
                <ProgramListV />
              </div>
